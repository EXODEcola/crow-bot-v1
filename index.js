...
client.on('message', message => {
  if (message.content === '+gay') {
    ...
    let amount = Math.floor(Math.random() * 100) + 1;
        ...
        .setDescription(`${message.author} vous êtes gay à ${amount}%`)
        .setThumbnail("https://images-na.ssl-images-amazon.com/images/I/317GyBOBK0L._AC_.jpg%22")
        .setColor("FFFF33") // 2f3136
        message.channel.send(embed)
        message.channel.send("https://i.gifer.com/7DKr.gif")
        console.log("Une personne viens de me demander si elle est GAY ;)")
  }
});
